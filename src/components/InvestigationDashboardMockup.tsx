  ...
  return (
    <section id="dashboard-mockup" className="py-20 border-b border-zinc-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-xl border border-zinc-300 bg-white shadow-lg overflow-hidden flex flex-col">
          {/* Top Window Bar */}
          <div className="px-4 py-3 bg-zinc-900 text-white flex items-center justify-between border-b border-zinc-800">
            ...
            <div className="flex items-center space-x-3 text-xs">
              ...
              <button className="px-2.5 py-1 rounded bg-blue-600 text-white text-[11px] font-bold hover:bg-blue-700 transition-colors">
                Export Dossier
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[700px]">
            {/* Sidebar (Mock) */}
            <div className="lg:col-span-3 border-r border-zinc-200 bg-zinc-50/70 p-4 space-y-6">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-2 px-2">
              ...
              {/* Active Case Context */}
              <div className="p-3.5 rounded-lg border border-zinc-200 bg-white space-y-2 text-xs">
                ...
                <div className="pt-2 border-t border-zinc-100 flex justify-between text-[10px] text-zinc-600">
                  <span>Processed: 142k rows</span>
                  <span className="text-blue-600 font-bold">100% Analyzed</span>
                </div>
              </div>
            </div>

            {/* Content Area */}
            <div className="lg:col-span-9 p-5 sm:p-6 space-y-6 overflow-y-auto max-h-[800px]">
              {/* 5 Main KPI Cards */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                <div className="p-3.5 rounded-lg border border-zinc-200 bg-white">
                  ...
                  <div className="text-lg sm:text-xl font-bold font-mono text-zinc-950 mt-1">
                    {DASHBOARD_METRICS.totalTransactions}
                  </div>
                  <span className="text-[10px] text-zinc-500 font-mono">In current dataset</span>
                </div>
                ...
                <div className="p-3.5 rounded-lg border border-zinc-200 bg-white">
                  ...
                  <span className="text-[10px] text-zinc-500 font-mono">Anomalous nodes</span>
                </div>
                ...
                <div className="p-3.5 rounded-lg border border-zinc-200 bg-white">
                  ...
                  <span className="text-[10px] text-zinc-500 font-mono">Tor/VPN relays</span>
                </div>
                ...
                <div className="p-3.5 rounded-lg border border-blue-200 bg-blue-50/30">
                  ...
                  <span className="text-[10px] text-blue-600 font-mono">Requires action</span>
                </div>

                <div className="p-3.5 rounded-lg border border-zinc-200 bg-white col-span-2 sm:col-span-1">
                  <div className="text-[10px] uppercase font-bold text-zinc-400">
                    Countries
                  </div>
                  <div className="text-lg sm:text-xl font-bold font-mono text-zinc-950 mt-1">
                  ...
                  <span className="text-[10px] text-zinc-500 font-mono">Cross-border hops</span>
                </div>
              </div>

              {/* Charts Row: Line Chart + Bar Chart + Category Distribution */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                {/* Line Chart: Transaction Velocity & Anomaly Volume */}
                <div className="lg:col-span-7 p-4 rounded-lg border border-zinc-200 bg-white space-y-3">
                  ...
                  <div className="flex items-center justify-center space-x-6 text-[10px] font-mono text-zinc-600">
                ...
                <div className="lg:col-span-5 p-4 rounded-lg border border-zinc-200 bg-white space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-zinc-900">
                      Top High-Risk Jurisdictions
                    </span>
                    <span className="text-[10px] font-mono text-zinc-500">Alerts Count</span>
                  </div>
                  ...
                  <div className="h-52 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={COUNTRY_DISTRIBUTION_DATA} layout="vertical">
                        ...
                        />
                        <Bar dataKey="alerts" fill="#18181b" radius={[0, 4, 4, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                ...
                <div className="lg:col-span-8 p-4 rounded-lg border border-zinc-200 bg-white space-y-3">
                  <div className="flex items-center justify-between">
                  ...
                  {/* SVG Node Graph */}
                  <div className="h-56 bg-zinc-50/50 rounded border border-zinc-200 p-2 overflow-hidden flex items-center justify-center">
                      ...
                      {MOCK_GRAPH_NODES.map((node) => {
                        ...
                        return (
                          ...
                          >
                            <circle
                              r={isTarget ? "18" : "14"}
                              fill={isTarget ? "#18181b" : "#ffffff"}
                              stroke={isTarget ? "#2563eb" : "#71717a"}
                  ...
                  <div className="flex items-center justify-between text-[11px] text-zinc-500">
                    ...
                    <span className="text-blue-600 font-bold">Hop Velocity: &lt; 90s</span>
                  </div>
                </div>

                {/* Pie Chart: Alert Categories */}
                <div className="lg:col-span-4 p-4 rounded-lg border border-zinc-200 bg-white space-y-3">
                  ...
                  <div className="pt-2 border-t border-zinc-100 text-[10px] text-zinc-500 font-mono text-center">
              ...
              <div className="rounded-lg border border-zinc-200 bg-white space-y-4 p-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-8 pr-3 py-1 text-xs rounded border border-zinc-300 bg-zinc-50 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-600 font-mono"
                      />
                    </div>
                    ...
                    <select
                      ...
                      className="px-2 py-1 text-xs rounded border border-zinc-300 bg-zinc-50 font-mono"
                    >
                    ...
                    <tbody className="divide-y divide-zinc-100">
                      {filteredAlerts.map((alert) => (
                        ...
                        >
                          ...
                          <td className="py-2.5 px-3 text-zinc-700 truncate max-w-[140px]">
                            {alert.shortWallet}
                          </td>
                          ...
                          <td className="py-2.5 px-3 text-zinc-600 truncate max-w-[150px]">
                            {alert.category}
                          </td>
        ...
        {selectedAlert && (
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-lg border border-zinc-300 shadow-2xl max-w-xl w-full overflow-hidden animate-fade-in">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <div className="p-2.5 rounded border border-zinc-200 bg-zinc-50 font-mono text-xs font-bold text-zinc-900 mt-1 break-all">
                    {selectedAlert.wallet}
                  </div>
                </div>

                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 rounded border border-zinc-200 bg-zinc-50">
                    <div className="text-[10px] text-zinc-500 font-mono">Threat Tier</div>
                  ...
                  <div className="p-3 rounded border border-zinc-200 bg-zinc-50">
                    <div className="text-[10px] text-zinc-500 font-mono">Volume</div>
                    <div className="text-sm font-bold text-zinc-900 mt-0.5">
                ...
                <div>
                  <div className="text-xs font-bold uppercase tracking-wider text-zinc-800 mb-2">
                  ...
                  <ul className="space-y-1.5">
                    {selectedAlert.reasons.map((r, i) => (
                      <li
                        key={i}
                        className="text-xs text-zinc-700 flex items-start space-x-2 p-2 rounded border border-zinc-100 bg-zinc-50/60"
                      >
              ...
              <div className="p-4 border-t border-zinc-200 bg-zinc-50 flex items-center justify-between">
                ...
                <button
                  onClick={() => setSelectedAlert(null)}
                  className="px-4 py-1.5 text-xs font-bold rounded bg-zinc-900 text-white hover:bg-zinc-800"
                >
                  Close Dossier
                </button>
              </div>
