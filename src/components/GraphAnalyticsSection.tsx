...
export function GraphAnalyticsSection() {
  ...
  return (
    <section id="graph-analytics" className="py-20 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 transition-colors">
        ...
        <div className="mb-12 p-6 rounded-lg border border-zinc-300 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 text-center">
            ...
            >
              ...
              <div className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">Victim Genesis</div>
            </div>
            ...
            >
              ...
              <div className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">50.0 BTC Split</div>
            </div>
            ...
            >
              ...
              <div className="text-[10px] text-zinc-600 dark:text-zinc-400 mt-0.5">Mule / Peel Hub</div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/60 dark:bg-zinc-900/60 text-xs text-zinc-700 dark:text-zinc-300 space-y-2">
              <div className="font-bold text-zinc-900 dark:text-zinc-100">Key Graph Heuristics:</div>
              <ul className="space-y-1.5 list-disc list-inside text-zinc-600 dark:text-zinc-400">
                <li><span className="font-semibold text-zinc-800 dark:text-zinc-200">PageRank:</span> Identifies primary laundering aggregation hubs.</li>
                <li><span className="font-semibold text-zinc-800 dark:text-zinc-200">Betweenness Centrality:</span> Pinpoints crucial money mule bridges connecting disjoint clusters.</li>
                <li><span className="font-semibold text-zinc-800 dark:text-zinc-200">CIOH (Common-Input):</span> Merges multiple input addresses into single-owner entities.</li>
              </ul>
            </div>
          </div>
