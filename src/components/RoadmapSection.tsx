...
import { CheckCircle2, Clock, Calendar, Shield, ArrowRight, GitCommit } from "lucide-react";
...
export function RoadmapSection() {
  ...
  return (
    <section id="roadmap" className="py-20 border-b border-zinc-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Timeline Layout */}
        <div className="relative border-l-2 border-zinc-200 ml-4 sm:ml-8 pl-6 sm:pl-8 space-y-10">
          {filteredSteps.map((step) => {
            ...
            return (
              <div key={step.step} className="relative group">
                {/* Timeline Pin Node */}
                <div
                  className={`absolute -left-[35px] sm:-left-[43px] top-1.5 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold font-mono border-2 bg-white ${
                    isDone
                ...
                {/* Content Card */}
                <div className="p-5 sm:p-6 rounded-lg border border-zinc-200 bg-white hover:border-zinc-400 hover:shadow-sm transition-all">
                  {/* Top Metadata */}
                  <div className="flex flex-wrap items-center justify-between gap-2 pb-3 mb-3 border-b border-zinc-100">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded border border-zinc-200 bg-zinc-50 text-zinc-600">
                        {step.duration}
                      </span>
                      <span
                  ...
                  {/* Objective */}
                  <p className="text-xs sm:text-sm text-zinc-700 leading-relaxed mb-4 font-medium">
                    {step.objective}
                  </p>
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-3 gap-2">
                      {step.keyDeliverables.map((item, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-zinc-600 p-2.5 rounded border border-zinc-100 bg-zinc-50/50 flex items-start space-x-2"
                        >
                  ...
                  <div className="flex items-center justify-between text-[11px] pt-3 border-t border-zinc-100 text-zinc-500 font-mono">
